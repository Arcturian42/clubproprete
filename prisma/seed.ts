    ...
    const suppliers = [
      {
        ...
        offerType: null,
        description: "Gamme complète de produits éco-labellisés pour le nettoyage tertiaire et industriel. Basés à Paris.",
      ...
      },
      {
        ...
        offerType: null,
        description: "Distributeur d'EPI : gants, chaussures, vêtements, masques. Stocks importants. Basés à Lyon.",
        deliveryAreas: "France entière",
        nationalCoverage: true,
      },
      {
      ...
      },
      {
        ...
        offerType: null,
        description: "Lavage, location et entretien du linge professionnel pour les sociétés de nettoyage. Basés à Nantes.",
      ...
      },
      {
        ...
        offerType: null,
        description: "Courtage en assurance, conseil RH et juridique spécialisé propreté. Basés à Bordeaux.",
        deliveryAreas: "France entière",
        nationalCoverage: true,
      },
    ];
    ...
    const missions = [
      {
        ...
        description: "Intervention urgente sur 3 jours pour nettoyage vitrerie en hauteur. Équipement fourni, accréditation hauteur requise.",
      ...
      },
      {
        ...
        description: "Remise en état post-travaux sur 800m² de bureaux. Matériel sur place, 2 jours estimés.",
